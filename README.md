...
Or if you'd like to compile it into an executable, refer to these instructions [here](https://github.com/WhatDidYouExpect/goober-central/blob/golang-rewrite/COMPILING.md)
